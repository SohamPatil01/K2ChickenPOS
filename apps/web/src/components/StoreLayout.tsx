          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center flex-1 min-w-0">
              <button
                ...
                className="lg:hidden p-2 -ml-2 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 touch-target"
              ...
              <Link href="/store" className="ml-1 lg:ml-0 flex items-center min-w-0">
                <span className="text-lg sm:text-xl font-bold text-brand-600 dark:text-brand-400 truncate">AzelaPOS</span>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
              {/* Offline Indicator */}
              {isOffline && (
                <div className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 bg-yellow-100 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-400 rounded-md text-xs sm:text-sm">
                  <span>🔴</span>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md touch-target whitespace-nowrap"
                >
