...
export default function StaffPage() {
  ...
  useEffect(() => {
    ...
    if (user.role !== 'OWNER') {
      alert('Access denied. Only Owners can access staff management.');
      router.push('/pos');
      return;
    }
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage staff members, roles, and credentials</p>
          </div>
          <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-2 mt-6">
                  <button
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-100 text-sm sm:text-base"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 disabled:opacity-50 text-sm sm:text-base"
                  >
