...
export default function HQPage() {
  ...
  useEffect(() => {
    ...
    // User is OWNER, redirect to dedicated HQ app
    console.log('[HQ Page] Redirecting to dedicated HQ app at port 3002');
          ...
          {user && user.role === 'OWNER' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                You are being redirected to the dedicated HQ application.
              </p>
