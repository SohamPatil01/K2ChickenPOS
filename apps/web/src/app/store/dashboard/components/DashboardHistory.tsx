      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500 dark:[color-scheme:dark]"
          />
          <button
            onClick={onLoad}
            disabled={loading}
      ...
      {historicalData && (
        <div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="bg-purple-100 dark:bg-purple-900/30 rounded-xl p-4 col-span-2 md:col-span-1">
