/** CA-style reports shown in the menu (Owner + Manager). */
export const CA_REPORT_ITEMS = [
  { id: 'bill-wise-sale', label: 'Bill Wise Sale (Sales Register)', path: '/reports/bill-wise-sale' },
