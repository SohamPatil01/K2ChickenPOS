...
export default function ThemeSettings() {
  ...
  const applyTheme = (mode: ThemeMode) => {
    ...
    // Save to both hq-theme and theme for compatibility
    localStorage.setItem('hq-theme', mode);
    ...
    return (
      <Card hasAccent>
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Choose your preferred theme mode</p>
        </div>
